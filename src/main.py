...
if __name__ == '__main__':
    ...
    if not args.text_model.pretrained:
        trained_report_generator = train_report_generator(train_dataset=REPORT_PREPROCESS_DIR + '/train_output.jsonl',
                                                          embedding_dim=200, lstm_units=256,
    ...
    # test trained
    generate_reports_and_save(trained_report_generator, REPORT_PREPROCESS_DIR + '/test_output.jsonl',
                              TRAINED_MODELS_DIR + '/generated_reports.json')
